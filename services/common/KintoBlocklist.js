...
const FILENAME_ADDONS_JSON  = "blocklist-addons.json";
const FILENAME_GFX_JSON     = "blocklist-gfx.json";
const FILENAME_PLUGINS_JSON = "blocklist-plugins.json";
...
class BlocklistClient {
  ...
  updateLastCheck(serverTime) {
    ...
    Services.prefs.setIntPref(this.checkPrefName, checkedServerTimeInSeconds);
  }
}
...
this.GfxClient = new BlocklistClient(
...
this.PluginClient = new BlocklistClient(
